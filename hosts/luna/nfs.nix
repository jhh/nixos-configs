{ config, pkgs, ... }:
{
  services.nfs.server = {
    ...
    exports = ''
      ...
      /mnt/tank/proxmox/pve   192.168.1.20(rw,insecure,sync,no_subtree_check,no_root_squash) 192.168.1.21(rw,insecure,sync,no_subtree_check,no_root_squash) 192.168.1.22(rw,insecure,sync,no_subtree_check,no_root_squash)
